...
export declare enum ENetworkDisconnectionReason {
...
export declare function eNetworkDisconnectionReasonFromJSON(object: any): ENetworkDisconnectionReason;
export declare function eNetworkDisconnectionReasonToJSON(object: ENetworkDisconnectionReason): string;
