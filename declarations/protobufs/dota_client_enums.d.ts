...
export declare enum ETournamentTemplate {
    k_ETournamentTemplate_None = 0,
    k_ETournamentTemplate_AutomatedWin3 = 1,
    UNRECOGNIZED = -1
}
export declare function eTournamentTemplateFromJSON(object: any): ETournamentTemplate;
export declare function eTournamentTemplateToJSON(object: ETournamentTemplate): string;
export declare enum ETournamentGameState {
...
export declare function eTournamentGameStateFromJSON(object: any): ETournamentGameState;
export declare function eTournamentGameStateToJSON(object: ETournamentGameState): string;
export declare enum ETournamentTeamState {
...
export declare function eTournamentTeamStateFromJSON(object: any): ETournamentTeamState;
export declare function eTournamentTeamStateToJSON(object: ETournamentTeamState): string;
export declare enum ETournamentState {
...
export declare function eTournamentStateFromJSON(object: any): ETournamentState;
export declare function eTournamentStateToJSON(object: ETournamentState): string;
export declare enum ETournamentNodeState {
...
export declare function eTournamentNodeStateFromJSON(object: any): ETournamentNodeState;
export declare function eTournamentNodeStateToJSON(object: ETournamentNodeState): string;
export declare enum EDOTAGroupMergeResult {
...
export declare function eDOTAGroupMergeResultFromJSON(object: any): EDOTAGroupMergeResult;
export declare function eDOTAGroupMergeResultToJSON(object: EDOTAGroupMergeResult): string;
export declare enum EPartyBeaconType {
    k_EPartyBeaconType_Available = 0,
    k_EPartyBeaconType_Joinable = 1,
    UNRECOGNIZED = -1
}
export declare function ePartyBeaconTypeFromJSON(object: any): EPartyBeaconType;
export declare function ePartyBeaconTypeToJSON(object: EPartyBeaconType): string;
