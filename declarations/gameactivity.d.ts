declare namespace Enum
{
	...
	export enum GameActivity
	{
		...
		ACT_DOTA_ARCANA_VOTE = 1766,
		ACT_DOTA_SPIRIT_BREAKER_ULT_RUN = 1767,
		ACT_DOTA_PUNCH = 1768,
		ACT_DOTA_CAST_STATUE = 1769,
		ACT_DOTA_ATTACK_STATUE = 1770,
		ACT_DOTA_CAST3_STATUE = 1771,
		ACT_DOTA_CAST1_STATUE = 1772,
		ACT_DOTA_TELEPORT_STATUE = 1773,
		ACT_DOTA_VICTORY_STATUE = 1774,
		ACT_DOTA_TAUNT_STATUE = 1775,
		ACT_DOTA_STATUE_SEQUENCE = 1776,
		ACT_DOTA_RUN_STATUE = 1777,
		ACT_DOTA_IDLE_STATUE = 1778,
		ACT_DOTA_CAST4_STATUE = 1779,
		ACT_DOTA_FLAIL_STATUE = 1780,
		ACT_DOTA_STUN_STATUE = 1781,
		ACT_DOTA_TELEPORT_END_STATUE = 1782,
		ACT_DOTA_DISABLED_END = 1784,
		ACT_DOTA_RELAX_IN = 1785,
		ACT_DOTA_RELAX_OUT = 1786,
		ACT_DOTA_CAST_FENCE = 1787,
		ACT_DOTA_RADIANT_CREEP_HAMMER = 1789,
		ACT_DOTA_SPWN = 1790,
		ACT_DOTA_RUN_ALT = 1791,
		ACT_DOTA_VOODOO_REST = 1792,
		ACT_DOTA_CYCLONE = 1793,
		ACT_DOTA_IMPALE = 1794
	}
}